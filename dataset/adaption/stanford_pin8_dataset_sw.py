...
class StanfordPin8DataSet(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, crop_size=(321, 321), sw_setting=None, mean=(128, 128, 128),
        ...
        with open('/hpc2hdd/JH_DATA/share/xzheng287/PrivateShareGroup/xzheng287_360/DATR-main/dataset/adaption/s2d3d_pin_list/name2label.json') as f:
            name2id = json.load(f)
        self.colors = np.load('/hpc2hdd/JH_DATA/share/xzheng287/PrivateShareGroup/xzheng287_360/DATR-main/dataset/adaption/s2d3d_pin_list/colors.npy')
...
if __name__ == '__main__':
    ...
    list_path = '/hpc2hdd/JH_DATA/share/xzheng287/PrivateShareGroup/xzheng287_360/DATR-main/dataset/adaption/s2d3d_pin_list/train.txt'
    # syn_dataset = synpassDataSet(root_syn, list_path, crop_size=(syn_h, syn_w), set='train')
    syn_h, syn_w = 2048, 2048
    syn_dataset = StanfordPin8DataSet(root_syn, list_path, crop_size=(syn_h, syn_w), set='train')
    image, label, _, _ = syn_dataset.__getitem__(1)
    trainloader = data.DataLoader(syn_dataset, batch_size=4)
